...
See the [architecture](../docs/development/ARCHITECTURE.md) and
[validation notes](../docs/development/VALIDATION.md) for implementation context.
...
Use Octocarte's own version sequence and release notes. Retained upstream tags
identify upstream history, not Octocarte releases. A source merge, an image build and deployment are separate operations.
...
Before publishing a release, review Git history and release artifacts for
...
overwritten. See [release packaging](../docs/development/RELEASING.md) and
[license and source requirements](../docs/development/LICENSING.md).
